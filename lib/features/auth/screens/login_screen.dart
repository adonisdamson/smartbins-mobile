          ...
          child: Form(
            ...
            child: Column(
              ...
              children: [
                ...
                Image.asset(HouseholdAssets.loginHero, height: 210, fit: BoxFit.contain),
                const SizedBox(height: 18),
                Text('Welcome back', style: HouseholdType.hero),
                const SizedBox(height: 8),
                Text('Book a pickup, track collectors, and manage payments from your SmartBins home.', style: HouseholdType.body.copyWith(color: HouseholdColors.gray)),
                ...
                const SizedBox(height: 12),
                HButton(label: 'Continue with Google', icon: 'google', secondary: true, onPressed: _loginGoogle),
                const SizedBox(height: 22),
                Center(child: TextButton(onPressed: () => Navigator.pushNamed(context, '/register'), child: Text('Create a SmartBins account', style: HouseholdType.body.copyWith(color: HouseholdColors.forest, fontWeight: FontWeight.w700)))),
              ],
            ),
          ),
        ),
