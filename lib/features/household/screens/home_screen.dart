...
class _PickupCard extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    final isActive = const ['ACCEPTED', 'EN_ROUTE', 'ON_THE_WAY', 'ARRIVED', 'COLLECTING', 'COLLECTED'].contains(status);
    return Padding(
            ...
            children: [
              Container(
                ...
                decoration: BoxDecoration(
                  color: (isActive ? HouseholdColors.ecoGreen : HouseholdColors.primary).withAlpha(24),
                  borderRadius: BorderRadius.circular(18),
                ),
                child: Center(child: HIcon('pickup', color: isActive ? HouseholdColors.ecoGreen : HouseholdColors.primary)),
              ),
                ...
                child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
                  ...
                  Row(children: [
                    Container(
                      ...
                      decoration: BoxDecoration(
                        color: (isActive ? HouseholdColors.ecoGreen : HouseholdColors.primary).withAlpha(20),
                        borderRadius: BorderRadius.circular(8),
                      ),
                      child: Text(
                        status.replaceAll('_', ' '),
                        style: HouseholdType.caption.copyWith(
                          color: isActive ? HouseholdColors.ecoGreen : HouseholdColors.primary,
