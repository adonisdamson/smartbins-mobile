            ...
            HCard(
              child: Column(
                children: [
                  ...
                  const SizedBox(height: 8),
                  Text(
                    'Your booking is synced with SmartBins and ready for live tracking.',
...
class _PaymentLogo extends StatelessWidget {
  ...
  static const _meta = {
    'mtn_momo':        (Color(0xFFFFCC00), Color(0xFF1A1A1A), 'MTN'),
    'telecel_cash':    (Color(0xFFE60028), Colors.white,      'TCL'),
    'airteltigo_money':(Color(0xFFE84419), Colors.white,      'ATG'),
    'cash':            (Color(0xFF19B661), Colors.white,      'GHS'),
    'wallet':          (Color(0xFF5483B3), Colors.white,      'WAL'),
  };

  @override
  Widget build(BuildContext context) {
    final m = _meta[id];
    final bg = m?.$1 ?? const Color(0xFFE8E4DD);
    final fg = m?.$2 ?? HouseholdColors.charcoal;
    final label = m?.$3 ?? id.toUpperCase().substring(0, 3);
    return Container(
      width: 56,
      height: 36,
      decoration: BoxDecoration(color: bg, borderRadius: BorderRadius.circular(10)),
      child: Center(child: Text(label, style: TextStyle(color: fg, fontWeight: FontWeight.w800, fontSize: 12, letterSpacing: 0.4))),
    );
  }
}
