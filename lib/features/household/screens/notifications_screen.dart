...
import '../../../shared/components/smartbins_avatar.dart';
            ...
            HCard(
              child: Row(children: [
                ...
                Expanded(child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
                  Text(user?.fullName ?? 'SmartBins household', style: HouseholdType.title),
          ...
          child: Column(children: [
            ...
            DropdownButtonFormField<int>(
              ...
              items: const [
                ...
                (5, 'Friday'),
                (6, 'Saturday'),
              ].map((d) => DropdownMenuItem(value: d.$1, child: Text(d.$2))).toList(),
...
const _kTermsSections = [
  (
    ...
    'By downloading, installing, or using the SmartBins application, you agree to be bound by these Terms of Service. If you do not agree to these terms, please do not use the app.',
  ),
  (
    '2. Description of Service',
    'SmartBins is a waste collection platform that connects households and businesses with independent waste collectors in Ghana. SmartBins acts as a marketplace facilitator and is not directly responsible for the quality or completion of collection services.',
  ),
  (
    '3. Eligibility',
    'You must be at least 18 years of age to use SmartBins. By registering, you represent and warrant that you meet this requirement and that all information you provide is accurate and complete.',
  ),
  (
    '4. Bookings & Payments',
    'Bookings are confirmed only upon successful payment via Mobile Money (MTN MoMo, Telecel Cash, or AirtelTigo) or cash on collection. Prices are denominated in Ghana Cedis (GHS). SmartBins reserves the right to update pricing at any time with reasonable notice.',
  ),
  (
    '5. Cancellations',
    'Households may cancel a booking up to 3 times per 24-hour period. Excessive cancellations may result in account restrictions. Collectors who cancel or fail to arrive may be subject to penalties at SmartBins\'s discretion.',
  ),
  (
    '6. Data & Privacy',
    'SmartBins collects location data, contact information, and transaction history to provide its service. Your data is stored securely and is never sold to third parties. Please review our Privacy Policy for full details.',
  ),
  (
    '7. Eco Rewards',
    'Eco Points earned through recyclable waste pickups have no cash value and may only be redeemed as discounts on future SmartBins bookings. Points expire after 12 months of account inactivity.',
  ),
  (
    '8. Liability',
    'SmartBins\'s liability is limited to the amount paid for the disputed booking. We are not liable for indirect damages, missed pickups due to force majeure, or disputes between users and Collectors that arise outside the app.',
  ),
  (
    '9. Account Termination',
    'SmartBins reserves the right to suspend or terminate any account that violates these terms, engages in fraudulent activity, or abuses the platform or its Collectors.',
  ),
  (
    '10. Governing Law',
  ...
  (
    '11. Contact',
    'For questions about these Terms of Service, please contact us at support@smartbins.eco or via the Help & Support section in the app.',
  ),
];
